...
public class ProjectionTransformPushFilter extends AbstractPushFilter<ColoredFace, ColoredFace> {
    private final PipelineData pipelineData;

    public ProjectionTransformPushFilter(PipelineData pipelineData) {
